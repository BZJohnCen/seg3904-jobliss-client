...
import * as styles from './wowjobs-list-item.emotion'
import WowjobsLogo from './wowjobs-logo.png'

const WowJobsListItem = (props) => {
    return (
        <Card css={styles.CardContainer} bordered={false} bodyStyle={styles.CardBodyStyle}>
            <Row style={{ height: '100%' }}>
                <Col lg={{ span: 4 }} xl={{ span: 3 }} css={styles.SourceLogoCol}>
                    <Tooltip title={`source: ${props.source}`} >
                    <div css={styles.SourceLogoContainer}>
                        <img src={WowjobsLogo} style={{ objectFit: 'contain', width: '100%' }} alt="no_logo" />
                    </div>
                    </Tooltip>
                </Col >
...
export default WowJobsListItem